...
`);await le(i,{kind:"submit_error",dedupKey:`submit_err:${t.source}:${t.message.slice(0,80)}`,waitMs:350})}async function Le(t,e,n={}){let i=String(e||"").trim();if(!i||!_n()&&!n.force)return;let o=Ac(t,i);if(Ti.has(o))return;Ti.add(o);let r=Mc(),s=await G(),l={at:Date.now(),source:String(t||"unknown"),message:i.slice(0,2e3),city:n.city||r.city,date:n.date||r.date,url:n.url||r.url,route:n.route||"",status:n.status!=null?String(n.status):"",email:s?.email||""};await Dc(l);try{await Ec(l)}catch{}try{Hr?.(l)}catch{}}function Ic(t){if(!_n())return;let e=t?.status,n=t?.retryAfter,i=t?.cgiBlock,o=`Request failed (HTTP ${e||"?"})`;n!=null&&(o+=` \u2014 retry after ${n}s`),i&&(o+=" \u2014 CGI access limitation"),Le("ajax_error",o,{status:e})}function Fr(t){if(!_n()||!t)return;let e=t.response||{};if(t.retryAfter!==void 0){Ic({status:t.status||429,retryAfter:t.retryAfter,cgiBlock:t.cgiBlock});return}if(!e.HasError)return;let n=e.ErrorString||"",o=(n?new DOMParser().parseFromString(n,"text/html").body.innerText.trim():"")||"Server returned HasError with no message";Le("ajax_response",o,{route:t.tail||""})}var Lc=[".atlas_validationalert",".alert-danger",".validation-summary-errors","#error_row .alert",".field-validation-error"];function Pc(){Ee&&c.clear(Ee);let t=()=>{if(!c.alive||!_n()){Ee=null;return}for(let e of Lc)for(let n of document.querySelectorAll(e)){let i=(n.textContent||"").replace(/\s+/g," ").trim();!i||i.length<4||Le("page_validation",i)}Ee=c.setTimeout(t,600)};Ee=c.setTimeout(t,500)}var Pe=0,Ur="",Kr=0;async function qc(){let[t,e]=await Promise.all([G(),C(["cgiIdToken"])]),n=ne(e.cgiIdToken);return{profile:t,token:n}}async function Gr(t){if(!B()||!await x("serverSync"))return null;let{profile:e,token:n}=await qc();if(!e?.id&&!e?.email)return null;try{let i={...t,profile:e};n&&(i.token=n);let o=await fetch(Eo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)}).then(r=>r.json());return o&&o.success?o:null}catch{return null}}async function zr({postId:t,postName:e,dayCount:n}={}){let i=String(t||"").trim(),o=Number(n)||0;if(!i||o<1)return null;let r=`${i}:${o}`,s=Date.now();if(r===Ur&&s-Kr<1500)return null;Ur=r,Kr=s;let l=await Gr({action:"alert",city:{id:i,name:String(e||i).trim()},dayCount:o});return l?.alertId&&(Pe=Math.max(Pe,Number(l.alertId)||0)),l}async function jr({preferredCities:t=[],citiesEnabled:e=!1,currentCityId:n=""}={}){if(!e||!t?.length)return null;let o=(await Gr({action:"poll",preferredCities:t,citiesEnabled:!0,currentCityId:String(n||""),lastAlertId:Pe}))?.forceCity;return!o?.id||!o?.alertId?null:o}function kn(t){let e=Number(t)||0;e>Pe&&(Pe=e)}var Rc=["cities","from","to","submitEnabled","citiesEnabled","enabled","slotWindows","termsAgreed","termsPassed","termsAgreedAt"];function Yr(t){if(!t||typeof t!="object")return{};let e={};for(let n of Rc)n in t&&(e[n]=t[n]);return typeof e.submitEnabled!="boolean"&&typeof e.enabled=="boolean"&&(e.submitEnabled=e.enabled),delete e.enabled,e}function Vr(t,e){if(!e||typeof e!="object")return t||null;let n=t&&typeof t=="object"?{...t}:{},i=Number(n.serverUpdatedAt)||0,o=Number(e.updatedAt)||0;if(o&&i&&o<i)return n;let r=Yr(e),s={...n,...r};return typeof r.submitEnabled=="boolean"&&(s.enabled=r.submitEnabled),e.updatedAt&&(s.serverUpdatedAt=e.updatedAt),s}async function Xr(){let[t,e]=await Promise.all([G(),C(["cgiIdToken"])]),n=ne(e.cgiIdToken);return{profile:t,token:n}}async function Qr(t){if(!B()||!await x("serverSync"))return!1;let e=Yr(t);if(!Object.keys(e).length)return!1;let{profile:n,token:i}=await Xr();if(!n?.id&&!n?.email)return!1;try{let o={profile:n,prefs:e};i&&(o.token=i);let r=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)}).then(s=>s.json());return!!(r&&r.success)}catch{return!1}}async function Jr(){if(!B()||!await x("serverSync"))return null;let{profile:t,token:e}=await Xr();if(!t?.id&&!t?.email)return null;try{let n=new URLSearchParams;t.id&&n.set("applicant_id",String(t.id)),t.email&&n.set("email",String(t.email));let i=await fetch(`${en}?${n.toString()}`,{method:"GET",headers:{Accept:"application/json"}}).then(r=>r.json());if(i?.prefs)return i.prefs;let o={profile:t};return e&&(o.token=e),i=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)}).then(r=>r.json()),i?.prefs||null}catch{return null}}var Pt="aiSubmitByAccount",Be=8e3;var X=25;var Ln=0,Oe=1e4,pa=1e3;function Fe(t){let e=Math.max(0,Number(t)||0);return e<=0?-1:e===1?0:e===2?1:2}function qi(){return b.cityRotateMinGapMs}function Oc(){return b.cityRotateMaxGapMs}function Ne(){return b.cityHoldMaxMs}function bt(){return b.cityLoadingMaxMs}function Ut(){return b.cityCalendarNoDatesMs}var Zr=5e3,$i=2e4,Nc=15e3;function _t(){return/\/(schedule|ofc-schedule)\/?$/i.test(location.pathname)||/\/(schedule|ofc-schedule)\b/i.test(location.pathname)}function Ri(){return/\/ofc-schedule\b/i.test(location.pathname)}function _(){return!!(/\/(interview|confirmation|appointment-confirmation|reschedule-confirmation|schedule\/confirm)/i.test(location.pathname)||document.querySelector("#appointment-confirmation, .appointment-confirmation"))}var Wc=[["What is your mother's maiden name?","What was the name of your first/current/favorite pet?","What was your first car?","What elementary school did you attend?","What is the name of the town/city where you were born?"],["Where did you meet your spouse?","What is your sibling's middle name?","Who was your childhood hero?","In what city or town was your first job?","What is the name of a college you applied to but didn't attend?"],["What is the name of the road/street you grew up on?","What is your least favorite food?","What was the first company that you worked for?","What is your favorite food?","What high school did you attend?"]];function Mn(t,e){let n=Wc[t]||[];return`<option value="">Select 1 question from set ${t+1}</option>`+n.map(o=>{let r=e===o?" selected":"";return`<option value="${o.replace(/"/g,"&quot;")}"${r}>${o}</option>`}).join("")}function ue(){let t=new Date,e=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${t.getFullYear()}-${e}-${n}`}function Vt(t){try{let[e,n,i]=t.split("-").map(Number);return new Date(e,n-1,i).toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"})}catch{return t}}function Hc(t,e,n){return`${t}-${String(e+1).padStart(2,"0")}-${String(n).padStart(2,"0")}`}function Bc(t){if(!t||!/^\d{4}-\d{2}-\d{2}$/.test(t))return null;let[e,n,i]=t.split("-").map(Number),o=new Date(e,n-1,i);return o.getFullYear()!==e||o.getMonth()!==n-1||o.getDate()!==i?null:o}function Oi(){for(let t of["from","to"]){let e=document.querySelector(p(t==="from"?a.aiFrom:a.aiTo)),n=document.querySelector(p(t==="from"?a.aiFromBtn:a.aiToBtn));if(!n)continue;let i=e?.value||"";n.textContent=i?Vt(i):"Select date"}}function _i(t,e){let n=document.querySelector(p(t==="from"?a.aiFrom:a.aiTo));if(n&&(n.value=e||""),t==="from"){let i=document.querySelector(p(a.aiTo));i&&e&&i.value&&i.value<e&&(i.value="")}Oi()}var J={y:0,m0:0,which:"from"};function qt(){document.querySelector(p(a.aiCal))?.classList.add(u.hidden)}function Ni(t){let e=t.target;return e?e.nodeType===3?e.parentElement:e:null}function Mi(){let t=document.querySelector(p(a.aiCal));if(!t)return;let{y:e,m0:n,which:i}=J,o=document.querySelector(p(i==="from"?a.aiFrom:a.aiTo))?.value||"",r=ue(),s=i==="to"&&document.querySelector(p(a.aiFrom))?.value||ue(),l=new Date(e,n,1).toLocaleDateString("en-IN",{month:"long",year:"numeric"}),d=new Date(e,n,1).getDay(),f=new Date(e,n+1,0).getDate(),g=new Date(e,n,0).getDate(),h="";for(let w of["S","M","T","W","T","F","S"])h+=`<div class="${u.aiHint}">${w}</div>`;for(let w=0;w<42;w++){let v,K=e,$=n,z=!1;w<d?(v=g-d+w+1,$=n-1,$<0&&($=11,K=e-1),z=!0):w>=d+f?(v=w-d-f+1,$=n+1,$>11&&($=0,K=e+1),z=!0):v=w-d+1;let S=Hc(K,$,v),H=S<s,ht=[u.aiCalDay,z?u.aiCalMuted:"",H?u.aiCalMuted:"",S===r?u.aiCalToday:"",S===o?u.aiCalOn:""].filter(Boolean).join(" ");h+=`<button type="button" class="${ht}" data-iso="${S}" ${H?'disabled aria-disabled="true"':""}>${v}</button>`}t.innerHTML=`
  ...
  `;let r=o.querySelector('select[data-win="from"]'),s=o.querySelector('select[data-win="dur"]');return c.on(r,"change",()=>{let l=Number(r.value),d=Number(s.value)||1;s.innerHTML=da(l,d),fa(o)}),c.on(s,"change",()=>fa(o)),c.on(o.querySelector('button[data-win="del"]'),"click",()=>{o.remove(),Zi()}),o}function Ji(t){let e=document.querySelector(p(a.aiWinList));if(!e)return;e.replaceChildren();let n=t?.slotWindows?.length?er(t.slotWindows):[];for(let i of n.slice(0,gt))e.appendChild(Aa(i.fromMin,i.durationMin));Zi(t)}function Zi(t){let e=document.querySelector(p(a.aiWinNote));e&&(t?.slotWindows?.length||On().length?e.textContent=`Custom windows active (max ${gt}, each \u2264 ${It} min).`:e.textContent=`Using defaults: ${st()}. Add up to ${gt} windows below.`)}function rt(t,e){t&&(t.classList.toggle(u.aiOnBtn,!!e),t.setAttribute("aria-checked",e?"true":"false"))}function sl(t){rt(document.querySelector(p(a.aiSubmitSw)),Ot(t)),rt(document.querySelector(p(a.aiCitiesSw)),Rt(t))}var it=!1,lt=!1;function Nn(t){let e=Ot(t)||it,n=Rt(t)||lt,i=document.querySelector(p(a.aiSubmitBody)),o=document.querySelector(p(a.aiCitiesBody));i&&i.classList.toggle(u.hidden,!e),o&&o.classList.toggle(u.hidden,!n)}function cl(t,e){let n=document.querySelector(p(a.aiStatus)),i=document.querySelector(p(a.aiBtn));if(!n||!i)return;sl(t),Nn(t);let o=Ot(t),r=Rt(t),s=o||r;s?(i.classList.add(u.aiOn),i.textContent="Tik Tik ON"):(i.classList.remove(u.aiOn),i.textContent="Tik Tik");let l=[];o&&t.from&&t.to?l.push(`Auto Submit ON (${Vt(t.from)} \u2013 ${Vt(t.to)}, clicks Submit as soon as time slot is ready)`):it&&!o?l.push("Auto Submit \u2014 set From / To dates, then Enable again"):l.push("Auto Submit OFF"),r?l.push(`City Change ON (${Vc(t)}, ${st()})`):lt&&!r?l.push("City Change \u2014 pick preferred cities, then Enable again"):l.push("City Change OFF"),n.textContent=`Account ${e||"\u2014"}: ${l.join(" \xB7 ")}`,n.classList.toggle(u.aiOk,s)}async function et(){let t=await q();if(t)try{await xa(t)}catch{}let e=t?await L(t):null;Ot(e)||(it=!1),Rt(e)||(lt=!1),$a(e),cl(e,t),Qi(e);let n=document.querySelector(p(a.aiFrom)),i=document.querySelector(p(a.aiTo));n&&(n.value=e?.from||""),i&&(i.value=e?.to||""),Oi();let o=(e?.cities||[]).map(S=>S.id),r=document.querySelector(p(a.aiPanel)),s=r&&!r.classList.contains(u.hidden),l=document.querySelector(p(a.aiCitiesBody)),d=l&&!l.classList.contains(u.hidden),f=ga();(d||Rt(e)||lt)&&He(s&&f.length?f:o),Ji(e);let g=document.querySelector(p(a.aiLogin)),h=document.querySelector(p(a.aiPass));g&&e?.loginId&&(g.value=e.loginId),h&&e?.loginPass&&(h.value=e.loginPass);let w=e?.security||[],v=[a.aiQ1,a.aiQ2,a.aiQ3],K=[a.aiA1,a.aiA2,a.aiA3];v.forEach((S,H)=>{let ht=document.querySelector(p(S));ht&&(ht.innerHTML=Mn(H,w[H]?.q||""))}),K.forEach((S,H)=>{let ht=document.querySelector(p(S));ht&&w[H]?.a&&(ht.value=w[H].a)});let $=document.querySelector(p(a.aiLoginBody)),z=$&&!$.classList.contains(u.hidden);to(!!z,yl(e))}function ll(){let t=document.querySelector(p(a.aiPanel));return!!(t&&!t.classList.contains(u.hidden))}function Ii(t){let e=document.querySelector(p(a.aiPanel));e&&(t||qt(),e.classList.toggle(u.hidden,!t),t&&q().then(async n=>{if(n)try{Ei=null,await xa(n)}catch{}let i=n?await L(n):null;Qi(i),ka(i)?He((i?.cities||[]).map(o=>o.id),{force:!0}):y("Read the terms, check Agree, then Continue.")}))}function Li(){if(Li._done)return;Li._done=!0;let t=e=>{if(!ll())return;let n=document.querySelector(p(a.aiPanel)),i=document.querySelector(p(a.aiBtn)),o=document.querySelector(p(a.aiCal)),r=Ni(e);if(!(o&&!o.classList.contains(u.hidden)&&r&&o.contains(r))){if(o&&!o.classList.contains(u.hidden)){let s=document.querySelector(p(a.aiFromBtn)),l=document.querySelector(p(a.aiToBtn));!(s&&r&&(s===r||s.contains(r)))&&!(l&&r&&(l===r||l.contains(r)))&&qt()}n&&r&&(n===r||n.contains(r))||i&&r&&(i===r||i.contains(r))||(qt(),Ii(!1))}};c.on(document,"pointerdown",t,{capture:!0})}async function ul(t){let e=await q();if(!e){y("Open a logged-in schedule page so we can bind this to your account.");return}let n=await L(e)||{},{from:i,to:o}=je();if(i=i||n.from||null,o=o||n.to||null,t){it=!0,rt(document.querySelector(p(a.aiSubmitSw)),!0),kt(),Qt(),Ui(),await Tt(e,{submitEnabled:!0,from:i||null,to:o||null,confirmedAt:Date.now()});let r=document.querySelector(p(a.aiFrom)),s=document.querySelector(p(a.aiTo));if(r&&i&&(r.value=i),s&&o&&(s.value=o),Oi(),await et(),rt(document.querySelector(p(a.aiSubmitSw)),!0),it=!0,Nn(await L(e)),!i||!o){y("Auto Submit ON \u2014 select From and To dates to start booking.");return}if(i>o){y("Auto Submit ON \u2014 From date must be before To date.");return}it=!1,y(`Auto Submit ON (${Vt(i)} \u2013 ${Vt(o)})`),await qn();return}it=!1,Qt(),rt(document.querySelector(p(a.aiSubmitSw)),!1),await Tt(e,{submitEnabled:!1,from:i||n.from,to:o||n.to}),await et(),y("Auto Submit OFF")}async function dl(t){let e=await q();if(!e){y("Open a logged-in schedule page so we can bind this to your account.");return}let n=await L(e)||{};if(t){lt=!0,rt(document.querySelector(p(a.aiCitiesSw)),!0),He((n.cities||[]).map(s=>s.id),{force:!0}),Ji(n);let o=Yt();!o.length&&n.cities?.length&&(o=n.cities);let r=On();if(kt(),await Tt(e,{citiesEnabled:!0,cities:o.length?o:n.cities||[],slotWindows:r.length?r:n.slotWindows||null}),await et(),rt(document.querySelector(p(a.aiCitiesSw)),!0),lt=!0,Nn(await L(e)),o.length||He([],{force:!0}),!o.length){y("City Change ON \u2014 select at least one preferred city to start hopping.");return}lt=!1,zi(),await Rn(),y(`City Change ON (${o.map(s=>s.name||s.id).join(", ")})`);return}lt=!1,Re(),rt(document.querySelector(p(a.aiCitiesSw)),!1);let i=Yt();await Tt(e,{citiesEnabled:!1,cities:i.length?i:n.cities||[]}),await et(),y("City Change OFF")}async function ma(){let t=await q();if(!t)return;let e=await L(t)||{};if(!Ot(e)&&!it)return;let{from:n,to:i}=je();!n||!i||n>i||(await Tt(t,{submitEnabled:!0,from:n,to:i,confirmedAt:Date.now()}),it=!1,await et(),rt(document.querySelector(p(a.aiSubmitSw)),!0),kt(),Ui(),y(`Auto Submit ON (${Vt(n)} \u2013 ${Vt(i)})`),await qn())}function fl(t){return(t||[]).map(e=>`:${String(e.fromMin).padStart(2,"0")}\u2013:${String(e.toMin).padStart(2,"0")}`).join(", ")}async function ml(){let t=document.querySelector(p(a.aiWinList));if(t){if(t.querySelectorAll(`.${u.aiWinRow}`).length>=gt){y(`Max ${gt} timing windows.`);return}t.appendChild(Aa(0,Math.min(6,It))),Zi()}}async function pl(){let t=await q();if(!t){y("Open a logged-in schedule page so we can bind this to your account.");return}let e=On();if(!e.length){y("Add at least one timing (or Reset to defaults).");return}await Tt(t,{slotWindows:e}),await et(),y(`Saved ${e.length} custom timing(s): ${fl(e)}`)}async function hl(){let t=await q();if(!t){y("Open a logged-in schedule page so we can bind this to your account.");return}window.confirm("Reset to default IST windows? Your custom timings will be removed.")&&(await Tt(t,{slotWindows:null}),li(),await et(),y(`Using default windows: ${st()}`))}async function gl(){let t=await q();if(!t){y("Open a logged-in schedule page so we can bind this to your account.");return}let{from:e,to:n}=je(),i=Yt(),o=document.querySelector(p(a.aiLogin))?.value?.trim(),r=document.querySelector(p(a.aiPass))?.value,s=[0,1,2].map(l=>({q:document.querySelector(p([a.aiQ1,a.aiQ2,a.aiQ3][l]))?.value?.trim()||"",a:document.querySelector(p([a.aiA1,a.aiA2,a.aiA3][l]))?.value?.trim()||""}));if(!o||!r){y("Enter ID and password before saving.");return}if(s.some(l=>!l.q||!l.a)){y("Pick 1 question from each of the 3 sets and fill all 3 answers.");return}await Tt(t,{}),to(!0,!0),y("Saved ID, password, and 3 security questions (1 from each set).")}function yl(t){let e=t?.security||[];return!!(t?.loginId&&t?.loginPass&&e.length>=3&&e.every(n=>n?.q&&n?.a))}function to(t,e){let n=document.querySelector(p(a.aiLoginToggle));if(!n)return;let i=t?"\u25BE":"\u25B8";n.textContent=e?`Login details (saved) ${i}`:`Login details ${i}`}function bl(){let t=document.querySelector(p(a.aiLoginBody)),e=document.querySelector(p(a.aiLoginToggle));if(!t||!e)return;let n=t.classList.contains(u.hidden);t.classList.toggle(u.hidden,!n);let i=/saved/i.test(e.textContent||"");to(n,i)}function eo(){for(let t of[...document.querySelectorAll("div[id]")])t.id!==a.aiPanel&&t.textContent?.includes("Tik Tik (this account only)")&&t.remove();for(let t of[...document.querySelectorAll("button")])(t.textContent||"").trim().startsWith("Tik Tik")&&t.id!==a.aiBtn&&t.remove();for(let t of[...document.querySelectorAll("div[id]")]){if(t.id===a.selRow||t.querySelector("#post_select"))continue;let e=[...t.querySelectorAll("button")];e.length&&e.every(n=>/^(Tik Tik|Recheck)/.test((n.textContent||"").trim()))&&t.remove()}}function Pi(){document.querySelector(p(a.aiPanel))?.remove(),document.querySelector(p(a.aiBtn))?.remove(),eo()}function wl(){if(_())return;if(!Ri()){Pi();return}if(document.querySelector(p(a.aiBtn)))if(!document.querySelector(p(a.aiSubmitSw))||!document.querySelector(p(a.aiTermsContinue))||!document.querySelector(p(a.aiFromBtn)))Pi();else return;let t=lr();if(!t)return;let e=document.createElement("button");e.id=a.aiBtn,e.type="button",e.textContent="Tik Tik",e.dataset[k.mark]="",c.on(e,"click",i=>{i.stopPropagation();let o=document.querySelector(p(a.aiPanel)),r=o&&o.classList.contains(u.hidden);Ii(!!r)}),t.appendChild(e);let n=document.createElement("div");n.id=a.aiPanel,n.className=u.hidden,n.dataset[k.mark]="",n.innerHTML=`
  ...
  `,document.documentElement.appendChild(t),t)}async function O(t,e){if(!chrome.runtime?.id||!c.alive||!await x("autoCloudflareTick"))return;let n=Pl(),i=n.querySelector("[data-cf-msg]"),o=n.querySelector("[data-cf-sub]"),r=n.querySelector("[data-cf-chip]"),s=n.querySelector(`.${u.cfHud}`);oo=t,i&&(i.textContent=io[t]||io.scanning),o&&(o.textContent=e||ql(t)),r&&(r.textContent=t==="success"?"Done":t==="manual"?"Help":"Active",r.dataset.state=t),s&&(s.dataset.state=t),Zt&&(c.clear(Zt),Zt=null),t==="success"&&(Zt=c.setTimeout(()=>ro(),2800))}function ql(t){return t==="debugger"?"Precision click via advanced browser bridge":t==="dom"?"Standard page interaction":t==="manual"?"One manual click is usually enough":t==="success"?"Resuming login and recovery":"Monitoring this tab for Turnstile"}function ro(){let t=document.querySelector(p(a.cfHud));t&&t.remove(),oo="",Zt&&(c.clear(Zt),Zt=null)}function ao(){return oo}var Rl=/we'?re sorry,\s*but something went wrong|error id\s*#\s*\[|contact the website administrator/i,Ol=/\bUSG\s+[a-f0-9-]{8,}/i;var co="vsPortalErrorReloadCount",Fa="vsPortalErrorReloadAt",Nl=2e3,Wl=1e4,Ha=!1,he=null,Hl=null;function Bl(){return(document.body?.innerText||document.body?.textContent||"").replace(/\s+/g," ").trim()}function ge(){let t=Bl().slice(0,6e3);return t?!!(/a timeout occurred/i.test(t)&&(/error\s*524/i.test(t)||/origin web server timed out/i.test(t)||/cloudflare ray id/i.test(t))||/error\s*524/i.test(t)&&/cloudflare/i.test(t)&&t.length<8e3||Rl.test(t)&&(Ol.test(t)||/error id\s*#/i.test(t))||/we'?re sorry,\s*but something went wrong/i.test(t)&&t.length<2500):!1}function Ua(){try{return Math.max(0,Number(sessionStorage.getItem(co)||0))}catch{return 0}}function Fl(){try{let t=Ua()+1;return sessionStorage.setItem(co,String(t)),sessionStorage.setItem(Fa,String(Date.now())),t}catch{return 1}}function so(){try{sessionStorage.removeItem(co),sessionStorage.removeItem(Fa)}catch{}}function Ul(t){return Math.min(Wl,Nl+Math.max(0,t-1)*1e3)}function Kl(){he&&(c.clear(he),he=null)}function Gl(){Fl();try{location.reload()}catch{}}function Ba(){if(!c.alive||he)return;if(!ge()){so();return}let t=Ua()+1,e=Ul(t);he=c.setTimeout(()=>{if(he=null,!!c.alive){if(!ge()){so();return}Gl()}},e)}function Ka(){if(Ha)return;Ha=!0;let t=()=>{c.alive&&(ge()?Ba():(so(),Kl()))};t(),Hl=c.setInterval(t,1500);try{let e=new MutationObserver(()=>{c.alive&&ge()&&Ba()});e.observe(document.documentElement,{childList:!0,subtree:!0,characterData:!0}),c.disposable(()=>e.disconnect())}catch{}}var Bn="vsDebugLogs",zl=200;function jl(){try{return new Date().toLocaleTimeString("en-IN",{hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return new Date().toISOString().slice(11,19)}}async function N(t,e,n){let i={at:Date.now(),t:jl(),tag:String(t||"app").slice(0,24),msg:String(e||"").slice(0,400)};if(n!=null)try{i.data=JSON.parse(JSON.stringify(n))}catch{i.data=String(n).slice(0,200)}try{console.log(`[VS6 ${i.tag}] ${i.msg}`,n!==void 0?n:"")}catch{}try{let o=await C({[Bn]:[]}),r=Array.isArray(o[Bn])?o[Bn].slice():[];for(r.push(i);r.length>zl;)r.shift();await T({[Bn]:r})}catch{}}var Un=null,Ve=0,Ye=null,Mt=0,Ga=0,Yl=25e3;async function Vl(){try{let e=(await C("humanClickProfile")).humanClickProfile,n=e?.liveTrained&&e.samples?.length||0;return n<5?15e3:n<20?1e4:n<50?6e3:3500}catch{return 12e3}}var uo=/verify you are human|verify you are a human|verify that you are human|performing security verification|just a moment|checking your browser|confirm you are human|not a robot|security verification|complete the security check|cloudflare/i;function Q(){return document.querySelector('input[name="cf-turnstile-response"], textarea[name="cf-turnstile-response"]')?.value?!0:!W()&&!ao()}function W(){if(ge()||document.querySelector('input[name="cf-turnstile-response"], textarea[name="cf-turnstile-response"]')?.value)return!1;let t=document.body?.innerText||"";return uo.test(t)&&/verify|human|moment|checking|robot|security/i.test(t)?!0:lo().length>0}function Fn(t){return new Promise(e=>setTimeout(e,t))}function Xl(){let t=[document],e=[document];for(;e.length;){let n=e.shift();for(let i of n.querySelectorAll("*"))i.shadowRoot&&(t.push(i.shadowRoot),e.push(i.shadowRoot))}return t}function lo(){let t=[],e=new Set,n=i=>{if(!i||e.has(i))return;let o=i.getBoundingClientRect();if(o.width<40||o.height<20||o.width>900||o.height>400)return;let r=(i.src||i.getAttribute?.("src")||"").toLowerCase(),s=(i.title||i.getAttribute?.("title")||"").toLowerCase(),l=(i.className?.toString?.()||"").toLowerCase(),d=(i.id||"").toLowerCase(),f=i.tagName==="IFRAME"&&(r.includes("challenges.cloudflare")||r.includes("turnstile")||s.includes("cloudflare")||s.includes("security challenge")),g=l.includes("cf-turnstile")||l.includes("turnstile")||d.includes("turnstile")||d.includes("challenge")||i.hasAttribute?.("data-sitekey")||i.hasAttribute?.("data-turnstile-widget");if(!f&&!g)if(i.tagName==="IFRAME"&&o.width>=120&&o.width<=420&&o.height>=45&&o.height<=120){if(!uo.test(document.body?.innerText||""))return}else return;e.add(i),t.push({el:i,rect:o})};for(let i of Xl()){for(let o of['iframe[src*="challenges.cloudflare"]','iframe[src*="turnstile"]','iframe[title*="Cloudflare"]','iframe[title*="security challenge"]',".cf-turnstile","[data-turnstile-widget]","#challenge-stage","#cf-turnstile","#turnstile-wrapper","[data-sitekey]"])for(let r of i.querySelectorAll(o))n(r);for(let o of i.querySelectorAll("iframe"))n(o)}return t}function Ql(t){for(let{el:e}of t)try{e.scrollIntoView({block:"center",behavior:"instant"})}catch{try{e.scrollIntoView({block:"center"})}catch{}}try{window.focus()}catch{}}function Jl(t){let e=[],n=new Set,i=(o,r)=>{if(!Number.isFinite(o)||!Number.isFinite(r)||o<1||r<1||o>window.innerWidth-1||r>window.innerHeight-1)return;let s=`${Math.round(o)},${Math.round(r)}`;n.has(s)||(n.add(s),e.push({x:Math.round(o),y:Math.round(r)}))};for(let{rect:o}of t){let r=o.top+o.height/2,s=o.left+Math.min(28,Math.max(18,o.width*.11));for(let l of[0,-4,4,-8,8,12,16,20,24,28,32])for(let d of[0,-3,3,-6,6])i(s+l,r+d);i(o.left+o.width*.5,r)}return e}function Zl(t){for(let{el:e,rect:n}of t)try{e.click();let i=n.left+Math.min(26,n.width*.12),o=n.top+n.height/2,r=document.elementFromPoint(i,o)||e;for(let s of["pointerdown","mousedown","mouseup","pointerup","click"])r.dispatchEvent(new MouseEvent(s,{bubbles:!0,cancelable:!0,clientX:i,clientY:o,view:window}))}catch{}for(let e of[".ctp-checkbox-label","label.ctp-checkbox-label","#challenge-stage label",".cf-turnstile input","#challenge-stage input[type='checkbox']","input[type='checkbox']"])for(let n of document.querySelectorAll(e)){let i=n.getBoundingClientRect();if(i.width<4&&i.height<4)continue;let o=(n.textContent||n.getAttribute("aria-label")||"").toLowerCase();if(e.includes("checkbox")&&!o.includes("human")&&!o.includes("verify")&&e==="input[type='checkbox']"){let r=n.closest("label, div, form");if(!uo.test(r?.textContent||""))continue}return n.click(),!0}return!1}async function za(t){t.length&&(Wa(t.slice(0,3)),c.send({action:"viewportClickPoints",points:t}),await x("cloudflareDebuggerClick")?(await O("debugger","Trained click on Verify you are human\u2026"),c.send({action:"cloudflareDebuggerClick",points:t,primaryOnly:!0})):await O("dom"))}function ja(){return/\/(schedule|ofc-schedule|c-schedule)\b/i.test(location.pathname||"")}function Ya(){if(!ja()||!W()||Q())return;let t=Date.now();if(!(t-Ga<Yl)){Ga=t,N("cf","verify-human on schedule \u2014 focusing Application Home for manual click"),O("manual","Verify you are human \u2014 opening Home tab so you can click it there\u2026").catch(()=>{});try{c.send({action:"focusHomeForVerify",ofcUrl:location.href})}catch{}}}async function Kn(){if(!await x("autoCloudflareTick"))return!1;if(Q())return Mt&&N("cf","challenge already solved"),Mt=0,await O("success"),!0;Ya(),Mt||(Mt=Date.now(),N("cf","challenge seen \u2014 train window started"));let t=await Vl();if(Date.now()-Mt<t)return await O("scanning",ja()?"Opening Home \u2014 click Verify you are human on the Home tab\u2026":"Train window \u2014 click Verify you are human yourself (recording your mouse)\u2026"),!1;N("cf","train window done \u2014 attempting auto click"),await O("scanning","Verify you are human page \u2014 preparing click\u2026");let e=lo();Ql(e),await Fn(350),e=lo();let n=Jl(e);return n.length&&(await za(n),await Fn(1200),Q()||!W())?(Mt=0,await O("success"),!0):(await O("dom"),Zl(e),await Fn(600),Q()||!W()?(Mt=0,await O("success"),!0):n.length&&(await za(n),await Fn(1e3),Q()||!W())?(Mt=0,await O("success"),!0):(Ve++,Ve>=8?await O("manual","Click the checkbox once \u2014 we will continue after."):await O("retry",`Retry ${Ve}/8\u2026`),!1))}function tu(){Ye||(Ye=new MutationObserver(()=>{c.alive&&W()&&!Q()&&(Ya(),Kn())}),Ye.observe(document.documentElement,{childList:!0,subtree:!0}),c.disposable(()=>{Ye?.disconnect(),Ye=null}))}function fo(){Un&&(c.clear(Un),Un=null),Ve=0,Mt=0,ro()}async function mo(){if(fo(),!await x("autoCloudflareTick"))return;tu();let t=async()=>{if(c.alive&&await x("autoCloudflareTick")){if(W()&&!Q()){await Kn();return}ao()&&(Ve=0,await O("success"))}};t(),Un=c.setInterval(t,1800)}var ye="sessionRecovery",po="homeKeepaliveAt",ho="homeLoadingStuckAt",bo="vsResubmitContinue",Va=2e3,zn=!1,Xa=null,go=null,yo=null,Gn=null,Xe=0;function xo(){try{let t=new URL(location.href);return t.searchParams.set("_vsr",String(Date.now()%1e12)),location.replace(t.pathname+t.search+t.hash),!0}catch{try{return location.href=location.pathname+location.search,!0}catch{return!1}}}function es(){try{if(sessionStorage.getItem(bo)!=="1")return!1;sessionStorage.removeItem(bo)}catch{return!1}return ft()||document.querySelector("#post_select")?!1:(xo(),!0)}function Qa(){return b.homeKeepaliveMinMs}function eu(){return b.homeKeepaliveMaxMs}function nu(){return b.homeKeepaliveDebounceMs}function Ja(){return b.loadingStuckMs}function iu(){return b.loadingStuckDebounceMs}function Za(t){return String(t||"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function ou(t,e){let n=Za(t);if(!n)return"";let i="",o=0;for(let r of e||[]){let s=Za(r.q);if(!s||!r.a)continue;if(n.includes(s)||s.includes(n))return r.a;let l=s.split(" ").filter(g=>g.length>3),d=0;for(let g of l)n.includes(g)&&d++;let f=l.length?d/l.length:0;f>o&&f>=.5&&(o=f,i=r.a)}return i}async function ru(){let t=await C([Pt,"profile"]),e=t[Pt]||{},n=t.profile?.id?String(t.profile.id):null,i=n?e[n]:null;return i||(i=Object.values(e).find(o=>o?.loginId&&o?.loginPass)||null),i||{}}function ts(t,e){if(!t)return;let n=t instanceof HTMLTextAreaElement?HTMLTextAreaElement.prototype:HTMLInputElement.prototype,i=Object.getOwnPropertyDescriptor(n,"value")?.set;i?i.call(t,e):t.value=e,t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0}))}function Wt(t){return new Promise(e=>setTimeout(e,t))}function dt(t,e){return t+Math.random()*(e-t)}async function wo(t,e){if(!t||e==null)return;let n=String(e);if(t.value===n)return;t.focus(),await Wt(dt(250,600)),ts(t,"");let i="";for(let o=0;o<n.length;o++){let r=n[o];i+=r,ts(t,i),t.dispatchEvent(new KeyboardEvent("keydown",{key:r,bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keypress",{key:r,bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:r,bubbles:!0}));let s=dt(90,220);/[\s@._]/.test(r)&&(s+=dt(120,320)),Math.random()<.08&&(s+=dt(200,450)),await Wt(s)}t.dispatchEvent(new Event("change",{bubbles:!0})),t.blur(),await Wt(dt(200,500))}var jn=!1,Yn=!1;function Vn(t){return!t||t.disabled?!1:(t.click(),!0)}function au(){let t=[...document.querySelectorAll("label, .form-check-label, span")],e=0;for(let i of t){let o=(i.textContent||"").toLowerCase();if(!/privacy act|confidentiality statement/.test(o))continue;let r=i.querySelector("input[type='checkbox']")||document.getElementById(i.getAttribute("for")||"");r&&!r.checked&&(Vn(r),e++)}let n=[...document.querySelectorAll("button, input[type='submit'], a.btn")].find(i=>/^(continue|ok|accept|agree)$/i.test((i.textContent||i.value||"").trim()));return e&&n&&Vn(n),e>0}function ns(){return!!(document.querySelector("#password")||document.querySelector("input[type='password']")||document.querySelector("#next")||/sign in/i.test(document.querySelector("button, input[type='submit']")?.value||""))}async function su(t){if(jn)return!0;let e=document.querySelector("#signInName, #signInNameReadOnly, input[type='email'], input[name='loginfmt']"),n=document.querySelector("#password, input[type='password']");if(!e&&!n)return!1;jn=!0;try{e&&t.loginId&&e.value!==t.loginId&&(await wo(e,t.loginId),await Wt(dt(400,900))),n&&t.loginPass&&!n.value&&(await wo(n,t.loginPass),await Wt(dt(500,1100)));let i=document.querySelector("#next, button#next, input[type='submit']#next")||[...document.querySelectorAll("button, input[type='submit']")].find(o=>/sign in|log in|continue/i.test(o.textContent||o.value||""));return i&&(n?.value||t.loginPass)?(await Wt(dt(600,1400)),Vn(i),!0):!!(e||n)}finally{jn=!1}}async function cu(t){if(Yn)return!0;let e=[],n=[...document.querySelectorAll("label, p, span, div.form-group")];for(let o of n){let r=(o.textContent||"").trim();if(r.length<12||r.length>220||!/\?/.test(r)&&!/born|spouse|school|pet|city|town|mother|father|street/i.test(r))continue;let s=o.querySelector("input[type='text']")||document.getElementById(o.getAttribute("for")||"")||o.parentElement?.querySelector("input[type='text']");s&&s.offsetParent!==null&&e.push({text:r,input:s})}for(let o of["kba1_response","kba2_response","kba3_response"]){let r=document.getElementById(o);if(!r)continue;let l=(r.closest(".form-group, .entry, li, div")||r.parentElement)?.textContent||"";e.some(d=>d.input===r)||e.push({text:l,input:r})}let i=[];for(let{text:o,input:r}of e){if(r.value)continue;let s=ou(o,t.security);s&&i.push({input:r,ans:s})}if(!i.length)return!1;Yn=!0;try{for(let{input:r,ans:s}of i)await wo(r,s),await Wt(dt(350,800));await Wt(dt(600,1400));let o=document.querySelector("button#continue, #continue")||[...document.querySelectorAll("button, input[type='submit']")].find(r=>/continue|submit|verify/i.test(r.textContent||r.value||""));return o&&Vn(o),!0}finally{Yn=!1}}function is(){let t=location.pathname||"";return/\/(schedule|ofc-schedule)/i.test(t)||W()||document.querySelector("input[type='password']")||document.querySelector("#kba1_response, #kba2_response")?!1:!!(document.querySelector(".username, #appointment-card, .usa-sidenav")||/visa application home|manage appointments/i.test(document.body?.innerText||""))}function ft(){return _t()||/\/(ofc-schedule|schedule|c-schedule)/i.test(location.pathname)}function lu(t=""){return/\/(ofc-schedule|schedule|c-schedule|interview|confirmation)/i.test(String(t||""))}function So(){if(ft()||document.querySelector("#post_select"))return!1;let t=location.pathname||"";return/atlasauth|b2clogin/i.test(location.host)||W()||/^\/(en-US)?\/?$/i.test(t)||/\/en-US\/?$/i.test(t)||document.querySelector(".username, #appointment-card")?!0:/visa application home/i.test(document.title||"")}function uu(t){return!!(t?.loginId&&t?.loginPass)}function du(){return is()?!1:!!(ns()||document.querySelector("#kba1_response, #kba2_response, #kba3_response")||document.querySelector("#signInName, #signInNameReadOnly, input[type='password']"))}async function fu(){let t=(await C(ye))[ye],e=!!t?.active,n=await ru();if(W()){await Kn();return}if(au(),is()){e&&(await T({[ye]:{...t,active:!1,doneAt:Date.now()}}),c.send({action:"recoveryReturnToOfc"}));return}du()&&uu(n)&&await x("autofillLogin")&&(await cu(n)||(ns()||document.querySelector("#signInName, #signInNameReadOnly, input[type='password']"))&&await su(n))}function os(){if(!So()||Xa)return;let t=async()=>{c.alive&&await fu()};t(),Xa=c.setInterval(t,1200)}function rs(){return Qa()+Math.random()*(eu()-Qa())}async function as(){try{let t=await C(po),e=Number(t[po])||0;return Date.now()-e<nu()?!1:(await T({[po]:Date.now()}),!0)}catch{return!0}}function ss(){if(ft()||!So()||document.querySelector("#post_select")||go)return;let t=()=>{c.alive&&(go=c.setTimeout(async()=>{if(go=null,!c.alive||ft()||lu(location.href)||document.querySelector("#post_select")||!So())return;if(jn||Yn||zn){t();return}if((await C(ye))[ye]?.active){t();return}if(!await as()){t();return}try{xo()}catch{t()}},rs()))};t()}function cs(){if(!ft()||yo)return;let t=()=>{c.alive&&(yo=c.setTimeout(async()=>{if(yo=null,!(!c.alive||!ft())){if(await as())try{c.send({action:"homeKeepalive",ofcUrl:location.href,ofcTabId:null})}catch{}t()}},rs()))};t()}async function mu(){try{let t=await C(ho),e=Number(t[ho])||0;return Date.now()-e<iu()?!1:(await T({[ho]:Date.now()}),!0)}catch{return!0}}function ls(){if(!ft()||Gn)return;let t=async()=>{if(Gn=null,!(!c.alive||!ft())){try{if(Bi()){if(Xe||(Xe=Date.now()),Date.now()-Xe>=Ja()){if(await mu()){try{I(`Date Loading stuck \u2265${Ja()/1e3}s \u2014 reloading Application Home\u2026`)}catch{}try{c.send({action:"homeKeepalive",ofcUrl:location.href,ofcTabId:null})}catch{}}Xe=Date.now()}}else Xe=0}catch{}c.alive&&ft()&&(Gn=c.setTimeout(t,Va))}};Gn=c.setTimeout(t,Va)}async function us(t){let e=String(t||"");if(/form resubmission|information that you entered|action that you took to be repeated|returning to that page might cause/i.test(e)){if(!ft()&&!document.querySelector("#post_select")){try{sessionStorage.setItem(bo,"1")}catch{}c.setTimeout(()=>xo(),300)}return}if(!/PSE0501|unable to load appointment available days/i.test(e)||zn)return;zn=!0,c.setTimeout(()=>{zn=!1},8e3);let n=await q();await T({[ye]:{active:!0,ofcUrl:location.href,accountId:n,startedAt:Date.now()}}),c.send({action:"recoveryStart",ofcUrl:location.href})}var Qn="humanClickProfile",Co=150,ko=120,pu=250,ds=!1,pt=[],Xn=0,nt=0,Ht=0,A=null,To=0,Je=!1,be=null,Jn=0,ti=0,Ze=[],mt=!1,te=!1;function hu(){let t=[];for(let e of document.querySelectorAll('iframe[src*="challenges.cloudflare"], iframe[src*="turnstile"], .cf-turnstile, [data-turnstile-widget], #challenge-stage, [data-sitekey]')){let n=e.getBoundingClientRect();n.width<40||n.height<20||n.width>900||n.height>400||t.push(n)}if(!t.length&&W())for(let e of document.querySelectorAll("iframe")){let n=e.getBoundingClientRect();n.width>=120&&n.width<=420&&n.height>=45&&n.height<=120&&t.push(n)}return t}function tn(){let t=hu();if(!t.length)return null;let e=t[0];return{x:e.left+Math.min(28,Math.max(18,e.width*.11)),y:e.top+e.height/2,w:e.width,h:e.height,left:e.left,top:e.top}}function we(t,e,n){return n?t>=n.left-40&&t<=n.left+n.w+40&&e>=n.top-30&&e<=n.top+n.h+30:!1}function hs(t){let e=performance.now();Xn||(Xn=e);let n=A,i=n?(t.clientX-n.x)/Math.max(24,n.w*.12):0,o=n?(t.clientY-n.y)/Math.max(20,n.h*.5):0;pt.push({nx:Math.round(i*1e3)/1e3,ny:Math.round(o*1e3)/1e3,x:Math.round(t.clientX),y:Math.round(t.clientY),t:Math.round(e-Xn)}),pt.length>ko&&pt.shift()}async function ei(){return(await C(Qn))[Qn]||{version:2,maxSamples:Co,samples:[],avgHoverMs:420,avgPressMs:70,avgApproachMs:800,liveTrained:!1}}function vo(t,e,n){if(!t.length)return n;let i=t.reduce((o,r)=>o+(Number(r[e])||0),0);return Math.round(i/t.length)}async function gs(t,{force:e=!1}={}){let n=Date.now();if(!e&&n-To<pu)return null;To=n;let i=await ei(),o=Array.isArray(i.samples)?i.samples.slice():[];for(t.clientId||(t.clientId=`hc-${t.at||n}-${Math.random().toString(36).slice(2,10)}`),t.uploaded=!1,o.push(t);o.length>Co;)o.shift();let r={version:2,maxSamples:Co,samples:o,avgHoverMs:vo(o,"hoverMs",420),avgPressMs:vo(o,"pressMs",70),avgApproachMs:vo(o,"approachMs",800),updatedAt:n,liveTrained:!0,source:"visa-page-live"};return await T({[Qn]:r}),Jn=o.length,N("human",`saved sample locally #${o.length}`,{capture:t.capture||"page",pressMs:t.pressMs,hoverMs:t.hoverMs,pathPts:Array.isArray(t.path)?t.path.length:0,clientId:t.clientId}),ys(t,r).catch(()=>{}),bs().catch(()=>{}),r}async function gu(t){if(!t)return;let e=await ei(),n=Array.isArray(e.samples)?e.samples.slice():[],i=!1;for(let o of n)o?.clientId===t&&!o.uploaded&&(o.uploaded=!0,i=!0);i&&await T({[Qn]:{...e,samples:n,updatedAt:Date.now()}})}async function ys(t,e){try{if(!await x("serverSync"))return N("upload","skipped \u2014 serverSync is OFF"),!1;let n=await G()||{},i=t.clientId||`hc-${t.at||Date.now()}-${Math.random().toString(36).slice(2,8)}`;t.clientId=i;let o={client_id:i,profile:{id:n.id||"",email:n.email||"",name:n.name||"",visa:n.visa||""},sample:t,profile_meta:{sampleCount:e?.samples?.length||0,avgHoverMs:e?.avgHoverMs,avgPressMs:e?.avgPressMs,avgApproachMs:e?.avgApproachMs,liveTrained:!0,source:"visa-page-live",extensionHost:location.host}};N("upload",`sending sample ${i}`,{sampleCount:e?.samples?.length||0,email:n.email||""}),c.send({action:"uploadHumanClickSample",payload:o});try{chrome.runtime.sendMessage({action:"uploadHumanClickSample",payload:o},r=>{if(chrome.runtime.lastError){N("upload",`SW error: ${chrome.runtime.lastError.message}`);return}r?.success?(N("upload",`server OK id=${r.id??"?"} status=${r.status??""}`,{clientId:i}),gu(i)):N("upload",`server FAIL ${r?.error||r?.status||"unknown"}`,{clientId:i})})}catch(r){N("upload",`sendMessage threw: ${r?.message||r}`)}return!0}catch(n){return N("upload",`upload threw: ${n?.message||n}`),!1}}async function bs(){try{if(!await x("serverSync"))return;let t=await ei(),n=(Array.isArray(t.samples)?t.samples:[]).filter(i=>i&&i.uploaded!==!0).slice(-40);for(let i of n)await ys(i,t),await new Promise(o=>setTimeout(o,80))}catch{}}function ws(t,e={}){let n=performance.now(),i=Math.max(25,Math.min(500,nt?n-nt:70)),o=Math.max(30,Math.min(3e3,nt?nt-(Ht||nt):200)),r=(pt.length?pt:Ze).slice(-ko),s=r.length?r[r.length-1].t:o,l=Math.max(o,Math.min(12e3,s||o)),d=be,f=A||tn();return{hoverMs:Math.round(o),pressMs:Math.round(i),approachMs:Math.round(l),path:r,down:d?{x:Math.round(d.x),y:Math.round(d.y)}:null,up:t?{x:Math.round(t.clientX),y:Math.round(t.clientY)}:d?{x:Math.round(d.x),y:Math.round(d.y)}:f?{x:Math.round(f.x),y:Math.round(f.y)}:null,target:f?{x:Math.round(f.x),y:Math.round(f.y),w:Math.round(f.w),h:Math.round(f.h),left:Math.round(f.left),top:Math.round(f.top)}:null,viewport:{w:window.innerWidth,h:window.innerHeight,dpr:window.devicePixelRatio||1,scrollX:Math.round(window.scrollX||0),scrollY:Math.round(window.scrollY||0)},pointerType:t?.pointerType||"mouse",url:location.pathname+location.search,at:Date.now(),...e}}function Qe(){pt.length&&(Ze=pt.slice(-ko)),pt=[],Xn=0,nt=0,Ht=0,be=null}function $o(){Je||(Je=!0,te=!0,Qe(),A=tn())}function _o(){Je=!1,A=null,mt=!1,Qe()}function Zn(t){let e=t?.target;if(!e)return!1;if(e.closest?.(".cf-turnstile, [data-turnstile-widget], #challenge-stage, [data-sitekey]"))return!0;if(e.tagName==="IFRAME"){let n=(e.src||"").toLowerCase();if(n.includes("challenges.cloudflare")||n.includes("turnstile"))return!0;let i=e.getBoundingClientRect();if(i.width>=120&&i.width<=420&&i.height>=45&&i.height<=120)return!0}return!1}async function fs(t){if(c.alive){if(!W()||Q()){Je&&_o();return}$o(),A||(A=tn()),!Ht&&A&&we(t.clientX,t.clientY,A)&&(Ht=performance.now()),A&&we(t.clientX,t.clientY,A)&&(ti=Date.now()),hs(t)}}async function ms(t){if(!(!c.alive||t.button!==0)&&!(!W()||Q())){$o(),A=tn(),nt=performance.now(),Ht||(Ht=nt),be={x:t.clientX,y:t.clientY},hs(t),(Zn(t)||A&&we(t.clientX,t.clientY,A))&&(mt=!0,ti=Date.now()),N("human","pointer down during challenge",{onWidget:Zn(t),near:!!(!A||we(t.clientX,t.clientY,A)),x:Math.round(t.clientX),y:Math.round(t.clientY)});try{O("scanning",`Recording click\u2026 (saved ${Jn} so far)`)}catch{}}}async function ps(t){if(!c.alive||t.button!==0||!nt&&!mt)return;if(!W()&&!Q()){Qe();return}if(!(A&&we(t.clientX,t.clientY,A)||A&&be&&we(be.x,be.y,A)||Zn(t)||mt||!A&&(pt.length>=2||Ze.length>=2))&&pt.length<2&&Ze.length<2){Qe();return}let n=ws(t,{capture:mt||Zn(t)?"iframe-or-widget":"page"});mt=!1,Qe();let i=await gs(n);if(!i)return;let o=i.samples?.length||0;try{O("success",`Saved verify-human click #${o} \u2014 uploaded to server`)}catch{}}async function yu(){let t=Date.now();if(!te||!Q()&&W())return;if(!(mt||t-ti<8e3||Ze.length>=2&&t-To>500)){te=!1,_o();return}let n=ws(null,{capture:"challenge-solved"});mt=!1,te=!1,_o();let i=await gs(n,{force:!0});if(!i)return;let o=i.samples?.length||0;try{O("success",`Saved verify-human click #${o} (after checkbox) \u2014 uploaded to server`)}catch{}}async function bu(){try{let t=await ei(),e=t.liveTrained&&t.samples?.length||0;return Jn=e,e}catch{return Jn}}function Ss(){if(ds)return;ds=!0,N("human","train watcher started",{path:location.pathname}),c.on(window,"pointermove",fs,{passive:!0,capture:!0}),c.on(window,"pointerdown",ms,{passive:!0,capture:!0}),c.on(window,"pointerup",ps,{passive:!0,capture:!0}),c.on(window,"mousemove",fs,{passive:!0,capture:!0}),c.on(window,"mousedown",ms,{passive:!0,capture:!0}),c.on(window,"mouseup",ps,{passive:!0,capture:!0}),c.on(window,"blur",()=>{!W()||Q()||(mt=!0,ti=Date.now(),nt||(nt=performance.now(),Ht||(Ht=nt)),N("human","page blur during challenge (likely iframe click)"))});let t=async()=>{if(!c.alive)return;if(W()&&!Q()){te||N("human","challenge detected \u2014 recording armed"),te=!0,$o(),A||(A=tn());let n=await bu();try{O("scanning",n?`Train mode \u2014 click Verify you are human naturally (saved ${n})`:"Train mode \u2014 move mouse naturally, then click Verify you are human (recording\u2026)")}catch{}return}(te||Je||mt)&&await yu()};t(),c.setInterval(t,1200),c.setTimeout(()=>{N("upload","flushing unsynced local samples\u2026"),bs().catch(()=>{})},2500)}var wu=`
#${a.selRow} {
  display: grid;
...
`;function xs(){if(document.querySelector(p(a.styles)))return;let t=document.createElement("style");t.id=a.styles,t.dataset[k.mark]="",t.textContent=wu,(document.head||document.documentElement).appendChild(t)}Fo();eo();Ao(()=>{Ta(),c.destroy()});Qo();Ka();_()&&q().then(t=>{if(t)return En(t);fe()}).catch(()=>fe());if(!_()){c.disposable(()=>{let i=document.querySelector(p(a.anchor)),o=document.querySelector("#post_select");i&&o&&i.replaceWith(o);for(let r of document.querySelectorAll("[data-"+k.mark+"]"))r.remove()}),xs(),c.send({action:"registerBlockGuard",prefix:m}),c.send({action:"registerRedirect",prefix:m}),c.send({action:"registerAlertGuard",prefix:m}),/\/(schedule|ofc-schedule)/i.test(location.pathname)&&c.send({action:"registerOfcReader",prefix:m}),c.on(window,"message",i=>{if(c.alive&&i.source===window)switch(i.data?.action){case Dt.req:return Na(i);case Dt.res:return Oa(i);case Dt.ofc:return xr(i);case Dt.err:return Le("native_alert",i.data?.text),We(String(i.data?.text||"alert").slice(0,120)),us(i.data?.text);case Dt.sub:hr(),Ie(),Er(),at().then(o=>{Ke(o?.accountId||null)}).catch(()=>{Ke(null)});return}}),chrome.storage.onChanged.addListener((i,o)=>{o==="local"&&(i.profile&&bi(),i.waitPillClock&&mr(i.waitPillClock.newValue),i.autoCloudflareTick&&(i.autoCloudflareTick.newValue?mo():fo()))}),c.on(document,"click",i=>{ce();let o=i.target.closest(p(a.waitTime));if(o){if(o.dataset.skipClick){delete o.dataset.skipClick;return}fr()}}),c.on(document,"keydown",ce),c.on(window,"focus",()=>ce({keepConsular:!0})),c.on(document,"visibilitychange",()=>{document.hidden||ce({keepConsular:!0})}),gr(),es(),os(),ss(),cs(),ls(),Ss(),mo();async function t(){!c.alive||_()||!_t()||document.querySelector("#post_select")&&(kt(),await Promise.all([pi(),gi(),no()]),qr({slotIndex:Ln,shouldPick:async()=>await at()?!0:!!await x("autoSelectFirstDate"),onSlotPicked:()=>_a()}))}async function e(){!c.alive||_()||!_t()||await Ca()}async function n(){Go(),jo(),await Promise.all([bi(),Vo(),Yo(),pi(),gi(),no()]),ri()}document.readyState==="complete"?n():c.on(window,"load",n),c.setInterval(t,2500),c.setInterval(e,3e4),e()}})();
