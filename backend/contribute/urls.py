...
urlpatterns = [
    ...
    path("contribute/hx/d", views.claim_auto_submit_date, name="claim_auto_submit_date_hx"),
    # Legacy aliases
    ...
    path("contribute/date-claim", views.claim_auto_submit_date, name="claim_auto_submit_date"),
]
